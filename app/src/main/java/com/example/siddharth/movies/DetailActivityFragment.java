package com.example.siddharth.movies;
...
import com.example.siddharth.movies.adapters.ReviewAdapter;
import com.example.siddharth.movies.adapters.TrailerAdapter;
import com.example.siddharth.movies.data.MovieContract;
import com.example.siddharth.movies.model.Movie;
import com.example.siddharth.movies.model.Review;
import com.example.siddharth.movies.model.Trailer;
...
public class DetailActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mMovie != null) {
            ...
            Picasso.with(this.getContext()).load(image_url).into(mImageView);
